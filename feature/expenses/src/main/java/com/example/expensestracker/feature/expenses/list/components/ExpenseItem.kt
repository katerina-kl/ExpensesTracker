...
import com.example.expensestracker.core.designsystem.category.iconRes
...
fun ExpenseItem(
    ...
    val baseColor = expense.category.color()
    ...
    Box(modifier = modifier) {
        Canvas(modifier = Modifier.matchParentSize()) {
            ...
            clipPath(clipPath) {
                ...
                drawRoundRect(
                    color = Color(ColorUtils.blendARGB(baseArgb, 0x000000, 0.2f)),
        ...
        IconButton(
            ...
            Icon(
                painter = painterResource(
                    com.example.expensestracker.core.designsystem.R.drawable.baseline_delete_24,
                ),
                contentDescription = stringResource(R.string.expenses_delete_cd),
                tint = MaterialTheme.colorScheme.onSurface,
                modifier = Modifier.size(24.dp),
            )
        }
